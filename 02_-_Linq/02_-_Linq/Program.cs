...
namespace _02___Linq
{
    class Program
    {
        static void Main()
        {
           ...
           /// - Två kopplingtabeller i script-form till Ämnen: från Elever och Lärare
           ///Bygga DB till modeller och fylla på data i Alla tabeller. (EF DB först)
           ...
           ///Uppdatera en student record om sina lärare är Anas till Reidar.
        }
    }
}
